...
class Server:
    def __init__(self):
        ...
        self.mapOutline = [[0, 0, 0, 1, 2, 1, 2, 1, 2, 0, 0, 0, 0, 1, 2, 1, 2, 1, 2, 0],
                           ...
                           [1, 4, 4, 4, 0, 0, 4, 4, 4, 4, 0, 0, 0, 1, 2, 1, 2, 1, 2, 0],
                           [1, 0, 2, 1, 1, 1, 3, 2, 2, 1, 0, 0, 0, 1, 2, 1, 2, 1, 2, 0],
                           [2, 0, 0, 2, 0, 1, 3, 2, 2, 1, 0, 0, 0, 1, 2, 1, 2, 1, 2, 0],
                           [2, 0, 1, 1, 1, 1, 1, 2, 0, 1, 0, 0, 0, 1, 2, 1, 2, 1, 2, 0],
